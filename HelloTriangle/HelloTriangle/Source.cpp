...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Caique Sobral - 125111365266", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 1.5f, 1.0f, 0.5f, 0.0f); //enviando cor para variável uniform inputColor
